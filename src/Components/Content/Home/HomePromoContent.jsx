...
const HomePromoContent = () => {
  ...
  return (
    <div name="promo" className='h-auto w-full bg-gradient-to-b from-[#F9F5F6] to-[hsl(346,37%,78%)] rounded-tr-full p-10 px-5 lg:px-10'>
      ...
      <div className="flex justify-between items-center rounded-xl text-[#4d494f] h-screen w-full bg-fit bg-no-repeat bg-center" style={{ backgroundImage: `url(${sliders[currentIndex].img})` }}>
