...
import { ControlledButton, ControlledCard, ControlledModal } from '../../../Components'
  ...
  const handleDiscountChange = (e) => {
    ...
    return (
      <>
          ...
          <ControlledModal open={modal} onClose={closeModal}
          children={
            <div className='h-auto w-auto flex justify-center items-center m-0'>
              <img src="/qr.png" alt="" className='h-[520px] w-full'  />
            </div>
          }
          />
      </>
