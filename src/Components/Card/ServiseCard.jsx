...
import ControlledCard from './Card'

const ServiseCard = ({text, img}) => {
  return (
    <ControlledCard>
       <div className="border border-black h-[55%] w-full">
       <img src={img} alt="image" className="border border-black h-[200px] lg:h-[350px] w-full lg:w-[450px]" />
       </div>
    ...
    // <div className="h-[30vh] md:h-[40vh] lg:h-[60vh] w-[80%] lg:w-full bg-[#F9F5F6] rounded-[20px] overflow-hidden shadow-lg">
