...
const Footer = () => {
  return (
    <div className='h-auto w-full bg-[#523240] text-white flex flex-col justify-center items-center py-5 lg:px-20'>
      <h4 className="w-full text-center text-2xl text-[#C88EA7] font-semibold my-5">About the company</h4>
       ...
       {/* <div className=" w-full h-2/4 flex flex-col lg:flex-row"> */}
        <div className=" w-2/4 h-full mx-20 flex flex-col lg:flex-row justify-center items-start lg:items-center gap-4 my-5">
        ...
        <div className="h-[65px] w-full flex justify-center items-center border-t-2 border-[#C88EA7] mt-14">
          <h6 className="text-[#C88EA7]">Copyright © 2023 The Royal Charm. All Rights Reserved</h6>
        </div> 
